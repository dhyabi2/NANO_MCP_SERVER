...
const Nano_node_1 = require("../Nano.node");
...
describe('Nano Node', () => {
    ...
    describe('Account Operations', () => {
        it('should get account balance', async () => {
            ...
            const result = await nano.execute.call(mockExecuteFunctions);
    ...
    describe('Custom Node Authentication', () => {
        it('should use custom node URL from credentials', async () => {
            ...
            await nano.execute.call(mockExecuteFunctions);
            expect(mockHelpers.request).toHaveBeenCalledWith({
                method: 'POST',
                uri: customUrl,
                body: {
    ...
    describe('Error Handling', () => {
        it('should throw error for invalid account address', async () => {
            ...
            await expect(nano.execute.call(mockExecuteFunctions))
